odoo.define('rowno_tree_sale_purchase.ListNumber', function (require) {
    "use strict";
    ...
    ListRenderer.include({
        ...
        _renderHeader: function (isGrouped) {
            ...
            if (this.hasSelectors && (this.state.model == 'sale.order.line' || this.state.model == 'purchase.order.line')) {
                ...
                if (this.mode !== 'edit' && (this.state.model == 'sale.order.line' || this.state.model == 'purchase.order.line')) {
        ...
        _renderRow: function (record) {
            ...
            if (this.mode !== 'edit' && this.state.groupedBy.length == 0 && (this.state.model == 'sale.order.line' || this.state.model == 'purchase.order.line')) {
